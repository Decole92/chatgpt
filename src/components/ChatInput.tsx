  ...
  return (
    <div className="">
      <div className="mx-5 my-5">
        ...
        >
          <input
            className="text-white flex-1 p-2 focus:outline-none bg-transparent disable:cursor-not-allowed"
            type="text"
            placeholder=""
            disabled={!session}
            value={prompt}
          ...
          >
            <PaperAirplaneIcon className="h-5 w-5 -rotate-45 text-gray-500 hover:hover:text-gray-50 " />
          </button>
        </form>
